...
pub const DISPLAY: &str = "AUTOTAKE";
...
/// Write the semaphore ID,0x0-0x7, to SMPH_ID to request this semaphore until it is granted.
///
///
///
...
///
/// - Software must wait until AUX_EVCTL:EVSTAT0.AUX_SMPH_AUTOTAKE_DONE is 1 before it writes a new value to SMPH_ID.
pub mod SMPH_ID {
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_SMPH::AUTOTAKE", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_SMPH::AUTOTAKE",
