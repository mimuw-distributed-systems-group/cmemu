...
pub const DISPLAY: &str = "FCFG_B1_START";
pub const OFFSET: u32 = 0x2414;
/// 0x40032414
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub B1_START_ADDR: B24,
        pub B1_MUX_FACTOR: B4,
        pub B1_MAX_SECTOR: B4,
    }
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::FCFG_B1_START", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::FCFG_B1_START",
