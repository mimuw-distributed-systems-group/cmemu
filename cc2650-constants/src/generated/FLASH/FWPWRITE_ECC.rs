...
pub const DISPLAY: &str = "FWPWRITE_ECC";
pub const OFFSET: u32 = 0x2140;
/// 0x40032140
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub ECCBYTES31_24: B8,
        pub ECCBYTES23_16: B8,
        pub ECCBYTES15_08: B8,
        pub ECCBYTES07_00: B8,
    }
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::FWPWRITE_ECC", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::FWPWRITE_ECC",
