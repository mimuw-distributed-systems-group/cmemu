...
pub const DISPLAY: &str = "FSM_ST_MACHINE";
pub const OFFSET: u32 = 0x227c;
/// 0x4003227c
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0x00800500;
...
/// Internal. Only to be used through TI provided API.
pub mod DBG_SHORT_ROW {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 7..=10;
    pub const BIT_MASK: u32 = 0x00000780;
    pub const BIT_WIDTH: u8 = 4;
    pub const RESET_VALUE: u32 = 0xa;
    pub const WRITABLE: bool = true;
}
/// Internal. Only to be used through TI provided API.
pub mod PGM_SEC_COF_EN {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        ...
        pub DIS_TST_EN: B1,
        pub PREC_STOP_EN: B1,
        pub PGM_SEC_COF_EN: B1,
        pub reserved_6_7: B1,
        pub DBG_SHORT_ROW: B4,
        pub DO_REDU_COL: B1,
        pub reserved_12_14: B2,
        pub ONE_TIME_GOOD: B1,
    ...
    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xff00b040;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::FSM_ST_MACHINE", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::FSM_ST_MACHINE",
