...
pub const DISPLAY: &str = "FCFG_B4_START";
pub const OFFSET: u32 = 0x2420;
/// 0x40032420
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub B4_START_ADDR: B24,
        pub B4_MUX_FACTOR: B4,
        pub B4_MAX_SECTOR: B4,
    }
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::FCFG_B4_START", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::FCFG_B4_START",
