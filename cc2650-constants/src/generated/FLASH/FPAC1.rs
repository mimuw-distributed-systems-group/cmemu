...
pub const DISPLAY: &str = "FPAC1";
pub const OFFSET: u32 = 0x2048;
/// 0x40032048
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0x02082081;
...
pub mod PSLEEPTDIS {
    ...
    pub const RESET_VALUE: u32 = 0x208;
    pub const WRITABLE: bool = true;
}
/// Internal. Only to be used through TI provided API.
pub mod PUMPRESET_PW {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub PUMPPWR: B2,
        pub reserved_2_4: B2,
        pub PUMPRESET_PW: B12,
        pub PSLEEPTDIS: B12,
        pub reserved_28_32: B4,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xf000000c;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::FPAC1", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::FPAC1",
