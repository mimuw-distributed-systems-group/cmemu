...
pub const DISPLAY: &str = "FSM_SECTOR";
pub const OFFSET: u32 = 0x22a4;
/// 0x400322a4
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub SEC_OUT: B4,
        pub SECTOR: B4,
        pub FSM_SECTOR_EXTENSION: B8,
        pub SECT_ERASED: B16,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0x00000000;
        const READ_ONLY_BITS_MASK: u32 = 0x0000ffff;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::FSM_SECTOR", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::FSM_SECTOR",
