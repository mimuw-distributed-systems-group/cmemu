...
pub const DISPLAY: &str = "EFUSE";
pub const OFFSET: u32 = 0x1000;
/// 0x40031000
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub DUMPWORD: B16,
        pub reserved_16_24: B8,
        pub INSTRUCTION: B5,
        pub reserved_29_32: B3,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xe0ff0000;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::EFUSE", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::EFUSE",
