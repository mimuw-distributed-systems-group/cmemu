...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        ...
        pub DIS_STANDBY: B1,
        pub reserved_2_3: B1,
        pub ENABLE_SWINTF: B1,
        pub DIS_READACCESS: B1,
        pub DIS_EFUSECLK: B1,
        pub STANDBY_PW_SEL: B2,
        pub STANDBY_MODE_SEL: B1,
        pub reserved_9_32: B23,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xfffffe04;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::CFG", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::CFG",
