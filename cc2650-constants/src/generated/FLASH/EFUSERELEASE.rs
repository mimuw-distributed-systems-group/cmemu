...
pub const DISPLAY: &str = "EFUSERELEASE";
pub const OFFSET: u32 = 0x1028;
/// 0x40031028
...
pub mod ODPYEAR {
    ...
    pub const BIT_RANGE: RangeInclusive<u8> = 25..=31;
    pub const BIT_MASK: u32 = 0xfe000000;
...
pub mod EFUSEYEAR {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 9..=15;
    pub const BIT_MASK: u32 = 0x0000fe00;
    pub const BIT_WIDTH: u8 = 7;
    pub const WRITABLE: bool = false;
}
/// Internal. Only to be used through TI provided API.
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FLASH::EFUSERELEASE", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FLASH::EFUSERELEASE",
