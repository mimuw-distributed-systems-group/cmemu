...
pub mod VALUE {
    ...
    pub const BIT_RANGE: RangeInclusive<u8> = 0..=24;
    pub const BIT_MASK: u32 = 0x01ffffff;
    pub const BIT_WIDTH: u8 = 25;
...
pub mod HwRegisterImpl {
    ...
    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xfe000000;
        const READ_ONLY_BITS_MASK: u32 = 0x01ffffff;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_TDCIF::RESULT", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_TDCIF::RESULT",
