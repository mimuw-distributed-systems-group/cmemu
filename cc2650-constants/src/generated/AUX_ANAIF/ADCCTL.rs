...
pub mod START_POL {
    ...
    pub mod Named {
        /// Set ADC trigger on falling edge of event source.
        pub const FALL: u32 = 1;
        /// Set ADC trigger on rising edge of event source.
...
///
///
/// Set START_SRC to NO_EVENT<n> if you want to trigger the ADC manually through ADCTRIG.START.
pub mod START_SRC {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    ...
    pub mod Named {
        ...
        /// No event.
        pub const NO_EVENT1: u32 = 10;
        /// No event.
        pub const NO_EVENT0: u32 = 9;
        /// Reserved - Do not use.
        pub const RESERVED1: u32 = 8;
        /// Reserved - Do not use.
        pub const RESERVED0: u32 = 7;
...
pub mod HwRegisterImpl {
    ...
    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xffffc0fc;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_ANAIF::ADCCTL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_ANAIF::ADCCTL",
