...
pub const DISPLAY: &str = "CCFG_TAP_DAP_1";
pub const OFFSET: u32 = 0xfe8;
/// 0x50003fe8
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0xffc5c5c5;
...
///
/// Any other value: WUC TAP access will remain disabled out of power-up/system-reset.
pub mod WUC_TAP_ENABLE {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub WUC_TAP_ENABLE: B8,
        pub PBIST1_TAP_ENABLE: B8,
        pub PBIST2_TAP_ENABLE: B8,
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CCFG::CCFG_TAP_DAP_1", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CCFG::CCFG_TAP_DAP_1",
