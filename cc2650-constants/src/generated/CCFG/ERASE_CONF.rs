...
pub const DISPLAY: &str = "ERASE_CONF";
pub const OFFSET: u32 = 0xfdc;
/// 0x50003fdc
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub BANK_ERASE_DIS_N: B1,
        pub reserved_1_8: B7,
        pub CHIP_ERASE_DIS_N: B1,
        pub reserved_9_32: B23,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xfffffefe;
        const READ_ONLY_BITS_MASK: u32 = 0x00000101;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CCFG::ERASE_CONF", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CCFG::ERASE_CONF",
