...
pub const DISPLAY: &str = "VOLT_LOAD_0";
pub const OFFSET: u32 = 0xfb8;
/// 0x50003fb8
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub VDDR_EXT_TM15: B8,
        pub VDDR_EXT_TP5: B8,
        pub VDDR_EXT_TP25: B8,
        pub VDDR_EXT_TP45: B8,
    }
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CCFG::VOLT_LOAD_0", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CCFG::VOLT_LOAD_0",
