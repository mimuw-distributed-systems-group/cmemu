...
pub const DISPLAY: &str = "CCFG_TAP_DAP_0";
pub const OFFSET: u32 = 0xfe4;
/// 0x50003fe4
...
///
/// Any other value: PRCM TAP access will remain disabled out of power-up/system-reset.
pub mod PRCM_TAP_ENABLE {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub TEST_TAP_ENABLE: B8,
        pub PRCM_TAP_ENABLE: B8,
        pub CPU_DAP_ENABLE: B8,
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CCFG::CCFG_TAP_DAP_0", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CCFG::CCFG_TAP_DAP_0",
