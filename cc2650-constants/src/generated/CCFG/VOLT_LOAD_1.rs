...
pub const DISPLAY: &str = "VOLT_LOAD_1";
pub const OFFSET: u32 = 0xfbc;
/// 0x50003fbc
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub VDDR_EXT_TP65: B8,
        pub VDDR_EXT_TP85: B8,
        pub VDDR_EXT_TP105: B8,
        pub VDDR_EXT_TP125: B8,
    }
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CCFG::VOLT_LOAD_1", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CCFG::VOLT_LOAD_1",
