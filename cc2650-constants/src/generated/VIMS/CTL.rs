...
///
/// 1: The in-built clock gate functionality is enabled, automatically gating the clock when not needed.
pub mod DYN_CG_EN {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
///
/// Note: Transaction from CACHE mode to GPRAM mode should be done through OFF mode to minimize flash block delay.
pub mod MODE {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0x1fffffc0;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::VIMS::CTL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::VIMS::CTL",
