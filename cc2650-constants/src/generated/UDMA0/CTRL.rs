...
pub mod BASEPTR {
    ...
    pub const BIT_RANGE: RangeInclusive<u8> = 10..=31;
    pub const BIT_MASK: u32 = 0xfffffc00;
    pub const BIT_WIDTH: u8 = 22;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub reserved_0_10: B10,
        pub BASEPTR: B22,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0x000003ff;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::UDMA0::CTRL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::UDMA0::CTRL",
