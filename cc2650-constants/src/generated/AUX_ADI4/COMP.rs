...
pub const DISPLAY: &str = "COMP";
pub const OFFSET: u32 = 0x5;
/// 0x400cb005
...
pub mod COMPA_REF_CURR_EN {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 6..=6;
    pub const BIT_MASK: u32 = 0x40;
    pub const BIT_WIDTH: u8 = 1;
    pub const RESET_VALUE: u32 = 0x0;
    pub const WRITABLE: bool = true;
}
...
pub mod COMPB_TRIM {
    ...
    pub mod Named {
        ...
        pub const DIV4: u32 = 7;
        /// Divide reference by 3
        pub const DIV3: u32 = 3;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        ...
        pub COMPB_EN: B1,
        pub COMPB_TRIM: B3,
        pub COMPA_REF_CURR_EN: B1,
        pub COMPA_REF_RES_EN: B1,
        pub reserved_8_32: B24,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xffffff02;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_ADI4::COMP", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_ADI4::COMP",
