...
pub const DISPLAY: &str = "GPT2BCAPTSEL";
pub const OFFSET: u32 = 0x404;
/// 0x40083404
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0x0000005a;
...
pub mod EV {
    ...
    pub const RESET_VALUE: u32 = 0x5a;
    pub const WRITABLE: bool = true;
    pub const RESET_ENUM: self::Values = self::Values::PORT_EVENT5;
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::EVENT::GPT2BCAPTSEL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::EVENT::GPT2BCAPTSEL",
