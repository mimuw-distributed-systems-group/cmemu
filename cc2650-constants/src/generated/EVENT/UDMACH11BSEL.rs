...
pub const DISPLAY: &str = "UDMACH11BSEL";
pub const OFFSET: u32 = 0x55c;
/// 0x4008355c
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0x0000004f;
...
pub mod EV {
    ...
    pub const RESET_VALUE: u32 = 0x4f;
    pub const WRITABLE: bool = true;
    pub const RESET_ENUM: self::Values = self::Values::GPT1A_DMABREQ;
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::EVENT::UDMACH11BSEL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::EVENT::UDMACH11BSEL",
