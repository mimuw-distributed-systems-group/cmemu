...
pub const DISPLAY: &str = "HFSR";
pub const OFFSET: u32 = 0xd2c;
/// 0xe000ed2c
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub reserved_0_1: B1,
        pub VECTTBL: B1,
        pub reserved_2_30: B28,
        pub FORCED: B1,
        pub DEBUGEVT: B1,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0x3ffffffd;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CPU_SCS::HFSR", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CPU_SCS::HFSR",
