...
pub mod VEC3_POL {
    ...
    pub mod Named {
        /// Falling edge triggers vector 3 execution.
        pub const FALL: u32 = 1;
        /// Rising edge triggers vector 3 execution.
...
pub mod VEC3_EN {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// Enable vector 3 trigger.
        pub const EN: u32 = 1;
        /// Disable vector 3 trigger.
        pub const DIS: u32 = 0;
    }
}
...
pub mod VEC2_POL {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// Falling edge triggers vector 2 execution.
        pub const FALL: u32 = 1;
        /// Rising edge triggers vector 2 execution.
        pub const RISE: u32 = 0;
    }
}
...
pub mod VEC2_EN {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// Enable vector 2 trigger.
        pub const EN: u32 = 1;
        /// Disable vector 2 trigger.
        pub const DIS: u32 = 0;
    }
}
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_EVCTL::VECCFG1", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_EVCTL::VECCFG1",
