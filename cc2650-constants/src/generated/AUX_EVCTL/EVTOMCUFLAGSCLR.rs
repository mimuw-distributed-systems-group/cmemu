...
pub const DISPLAY: &str = "EVTOMCUFLAGSCLR";
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        ...
        pub TIMER0_EV: B1,
        pub TIMER1_EV: B1,
        pub SMPH_AUTOTAKE_DONE: B1,
        pub ADC_DONE: B1,
        pub ADC_FIFO_ALMOST_FULL: B1,
        pub OBSMUX0: B1,
        pub ADC_IRQ: B1,
    ...
    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xfffff800;
        const READ_ONLY_BITS_MASK: u32 = 0x00000000;
        const WRITE_ONLY_BITS_MASK: u32 = 0x000007ff;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_EVCTL::EVTOMCUFLAGSCLR", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_EVCTL::EVTOMCUFLAGSCLR",
