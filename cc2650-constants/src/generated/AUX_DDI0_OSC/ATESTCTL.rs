...
pub const DISPLAY: &str = "ATESTCTL";
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub reserved_0_29: B29,
        pub SCLK_LF_AUX_EN: B1,
        pub SPARE30: B2,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0x1fffffff;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_DDI0_OSC::ATESTCTL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_DDI0_OSC::ATESTCTL",
