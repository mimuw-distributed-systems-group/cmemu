...
pub const DISPLAY: &str = "ADCDOUBLERNANOAMPCTL";
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub ADC_IREF_CTRL: B2,
        pub reserved_2_4: B2,
        pub ADC_SH_VBUF_EN: B1,
        pub ADC_SH_MODE_EN: B1,
        pub reserved_6_23: B17,
        pub SPARE23: B1,
        pub NANOAMP_BIAS_ENABLE: B1,
        pub reserved_25_32: B7,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xfe7fffcc;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_DDI0_OSC::ADCDOUBLERNANOAMPCTL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_DDI0_OSC::ADCDOUBLERNANOAMPCTL",
