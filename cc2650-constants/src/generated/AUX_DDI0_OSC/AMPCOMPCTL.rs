...
pub const DISPLAY: &str = "AMPCOMPCTL";
...
/// Internal. Only to be used through TI provided API.
pub mod AMPCOMP_FSM_UPDATE_RATE {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 28..=29;
    pub const BIT_MASK: u32 = 0x30000000;
    ...
    pub mod Named {
        /// Internal. Only to be used through TI provided API.
        pub const _250KHZ: u32 = 3;
        /// Internal. Only to be used through TI provided API.
        pub const _500KHZ: u32 = 2;
        /// Internal. Only to be used through TI provided API.
        pub const _1MHZ: u32 = 1;
        /// Internal. Only to be used through TI provided API.
        pub const _2MHZ: u32 = 0;
    }
}
/// Internal. Only to be used through TI provided API.
pub mod AMPCOMP_SW_CTRL {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
/// Internal. Only to be used through TI provided API.
pub mod LPM_IBIAS_WAIT_CNT_FINAL {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
/// Internal. Only to be used through TI provided API.
pub mod IBIASCAP_HPTOLP_OL_CNT {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub IBIASCAP_HPTOLP_OL_CNT: B4,
        pub CAP_STEP: B4,
        pub LPM_IBIAS_WAIT_CNT_FINAL: B8,
        pub IBIAS_INIT: B4,
        pub IBIAS_OFFSET: B4,
        pub reserved_24_26: B2,
        pub AMPCOMP_SW_EN: B1,
        pub AMPCOMP_SW_CTRL: B1,
        pub AMPCOMP_FSM_UPDATE_RATE: B2,
        pub AMPCOMP_REQ_MODE: B1,
        pub SPARE31: B1,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0x03000000;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_DDI0_OSC::AMPCOMPCTL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_DDI0_OSC::AMPCOMPCTL",
