...
pub const DISPLAY: &str = "DMAPORTERR";
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub reserved_0_9: B9,
        pub LAST_CH: B1,
        pub reserved_10_12: B2,
        pub AHB_ERR: B1,
        pub reserved_13_32: B19,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xffffedff;
        const READ_ONLY_BITS_MASK: u32 = 0x00001200;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CRYPTO::DMAPORTERR", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CRYPTO::DMAPORTERR",
