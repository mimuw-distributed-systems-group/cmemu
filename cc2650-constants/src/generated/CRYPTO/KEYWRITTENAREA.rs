...
pub const DISPLAY: &str = "KEYWRITTENAREA";
...
pub mod RAM_AREA_WRITTEN7 {
    ...
    pub mod Named {
        /// This RAM area is written with valid key information
        pub const WRITTEN: u32 = 1;
        /// This RAM area is not written with valid key information
        pub const NOT_WRITTEN: u32 = 0;
    }
}
/// On read this bit returns the key area written status.
///
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub RAM_AREA_WRITTEN0: B1,
        pub RAM_AREA_WRITTEN1: B1,
        pub RAM_AREA_WRITTEN2: B1,
        pub RAM_AREA_WRITTEN3: B1,
        pub RAM_AREA_WRITTEN4: B1,
        pub RAM_AREA_WRITTEN5: B1,
        pub RAM_AREA_WRITTEN6: B1,
        pub RAM_AREA_WRITTEN7: B1,
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CRYPTO::KEYWRITTENAREA", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CRYPTO::KEYWRITTENAREA",
