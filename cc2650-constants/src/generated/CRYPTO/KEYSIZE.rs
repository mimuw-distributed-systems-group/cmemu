...
pub mod SIZE {
    ...
    pub mod Named {
        /// Not supported
        pub const _256_BIT: u32 = 3;
        /// Not supported
        pub const _192_BIT: u32 = 2;
        /// 128 bits
        pub const _128_BIT: u32 = 1;
    }
}
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CRYPTO::KEYSIZE", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CRYPTO::KEYSIZE",
