...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub CH0_ACTIVE: B1,
        pub CH1_ACTIVE: B1,
        pub reserved_2_17: B15,
        pub PORT_ERR: B1,
        pub reserved_18_32: B14,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xfffdfffc;
        const READ_ONLY_BITS_MASK: u32 = 0x00020003;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::CRYPTO::DMASTAT", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::CRYPTO::DMASTAT",
