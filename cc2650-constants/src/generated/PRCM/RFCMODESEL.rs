...
pub const DISPLAY: &str = "RFCMODESEL";
pub const OFFSET: u32 = 0x1d0;
/// 0x400821d0
...
pub mod CURR {
    ...
    pub mod Named {
        /// Select Mode 7
        pub const MODE7: u32 = 7;
        /// Select Mode 6
        pub const MODE6: u32 = 6;
        /// Select Mode 5
        pub const MODE5: u32 = 5;
        /// Select Mode 4
        pub const MODE4: u32 = 4;
        /// Select Mode 3
        pub const MODE3: u32 = 3;
        /// Select Mode 2
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::PRCM::RFCMODESEL", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::PRCM::RFCMODESEL",
