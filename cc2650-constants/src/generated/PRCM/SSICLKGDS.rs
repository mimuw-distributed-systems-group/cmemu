...
pub const DISPLAY: &str = "SSICLKGDS";
...
pub mod CLK_EN {
    ...
    pub mod Named {
        ...
        pub const SSI1: u32 = 2;
        /// Enable clock for SSI0
        pub const SSI0: u32 = 1;
    }
}
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::PRCM::SSICLKGDS", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::PRCM::SSICLKGDS",
