...
pub const DISPLAY: &str = "GPTCLKGDS";
...
pub mod CLK_EN {
    ...
    pub mod Named {
        ...
        pub const GPT3: u32 = 8;
        /// Enable clock for GPT2
        pub const GPT2: u32 = 4;
        /// Enable clock for GPT1
        pub const GPT1: u32 = 2;
        /// Enable clock for GPT0
        pub const GPT0: u32 = 1;
    }
}
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::PRCM::GPTCLKGDS", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::PRCM::GPTCLKGDS",
