...
pub const DISPLAY: &str = "CONFIG_IF_ADC";
pub const OFFSET: u32 = 0x34c;
/// 0x5000134c
...
pub mod INT2ADJ {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 10..=13;
    pub const BIT_MASK: u32 = 0x00003c00;
    pub const BIT_WIDTH: u8 = 4;
    pub const WRITABLE: bool = false;
}
/// Internal. Only to be used through TI provided API.
pub mod IFDIGLDO_TRIM_OUTPUT {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 5..=9;
    pub const BIT_MASK: u32 = 0x000003e0;
    pub const BIT_WIDTH: u8 = 5;
    pub const WRITABLE: bool = false;
}
/// Internal. Only to be used through TI provided API.
pub mod IFANALDO_TRIM_OUTPUT {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub IFANALDO_TRIM_OUTPUT: B5,
        pub IFDIGLDO_TRIM_OUTPUT: B5,
        pub INT2ADJ: B4,
        pub AAFCAP: B2,
        pub FF1ADJ: B4,
        pub INT3ADJ: B4,
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FCFG1::CONFIG_IF_ADC", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FCFG1::CONFIG_IF_ADC",
