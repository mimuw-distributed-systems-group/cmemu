...
pub const DISPLAY: &str = "MISC_OTP_DATA_1";
pub const OFFSET: u32 = 0x398;
/// 0x50001398
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0xe00403f8;
pub const RESET_MASK: u32 = 0xffffffff;
/// Internal. Only to be used through TI provided API.
pub mod PEAK_DET_ITRIM {
...
/// Internal. Only to be used through TI provided API.
pub mod DBLR_LOOP_FILTER_RESET_VOLTAGE {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HPM_IBIAS_WAIT_CNT {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 10..=19;
    pub const BIT_MASK: u32 = 0x000ffc00;
    pub const BIT_WIDTH: u8 = 10;
    pub const RESET_VALUE: u32 = 0x100;
    pub const WRITABLE: bool = false;
}
/// Internal. Only to be used through TI provided API.
pub mod LPM_IBIAS_WAIT_CNT {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    pub const BIT_RANGE: RangeInclusive<u8> = 4..=9;
    pub const BIT_MASK: u32 = 0x000003f0;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        ...
        pub DBLR_LOOP_FILTER_RESET_VOLTAGE: B2,
        pub LP_BUF_ITRIM: B2,
        pub HP_BUF_ITRIM: B3,
        pub PEAK_DET_ITRIM: B2,
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FCFG1::MISC_OTP_DATA_1", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FCFG1::MISC_OTP_DATA_1",
