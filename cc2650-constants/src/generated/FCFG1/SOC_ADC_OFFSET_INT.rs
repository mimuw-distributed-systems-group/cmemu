...
pub const DISPLAY: &str = "SOC_ADC_OFFSET_INT";
pub const OFFSET: u32 = 0x368;
/// 0x50001368
...
pub mod SOC_ADC_REL_OFFSET_TEMP1 {
...
pub mod SOC_ADC_ABS_OFFSET_TEMP1 {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        pub SOC_ADC_ABS_OFFSET_TEMP1: B8,
        pub reserved_8_16: B8,
        pub SOC_ADC_REL_OFFSET_TEMP1: B8,
        pub reserved_24_32: B8,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xff00ff00;
        const READ_ONLY_BITS_MASK: u32 = 0x00ff00ff;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FCFG1::SOC_ADC_OFFSET_INT", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FCFG1::SOC_ADC_OFFSET_INT",
