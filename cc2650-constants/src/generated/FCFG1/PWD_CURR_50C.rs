...
pub const DISPLAY: &str = "PWD_CURR_50C";
pub const OFFSET: u32 = 0x3a4;
/// 0x500013a4
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0x1218a20d;
...
pub mod DELTA_CACHE_REF {
    ...
    pub const RESET_VALUE: u32 = 0x12;
...
pub mod DELTA_RFMEM_RET {
    ...
    pub const BIT_WIDTH: u8 = 8;
    pub const RESET_VALUE: u32 = 0x18;
    pub const WRITABLE: bool = false;
}
...
pub mod DELTA_XOSC_LPM {
    ...
    pub const BIT_WIDTH: u8 = 8;
    pub const RESET_VALUE: u32 = 0xa2;
    pub const WRITABLE: bool = false;
}
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FCFG1::PWD_CURR_50C", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FCFG1::PWD_CURR_50C",
