...
pub const DISPLAY: &str = "BAT_RC_LDO_TRIM";
pub const OFFSET: u32 = 0x2bc;
/// 0x500012bc
...
pub mod HwRegisterImpl {
    ...
    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xf0f0f0fc;
        const READ_ONLY_BITS_MASK: u32 = 0x0f0f0f03;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FCFG1::BAT_RC_LDO_TRIM", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FCFG1::BAT_RC_LDO_TRIM",
