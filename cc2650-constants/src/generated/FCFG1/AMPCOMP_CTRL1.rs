...
pub const DISPLAY: &str = "AMPCOMP_CTRL1";
pub const OFFSET: u32 = 0x378;
/// 0x50001378
pub const ADDR: Address = super::ADDR.offset(OFFSET);
pub const BIT_SIZE: u8 = 32;
pub const RESET_VALUE: u32 = 0xff183f47;
...
pub mod HwRegisterImpl {
    ...
    pub struct Bitfields {
        ...
        pub IBIAS_INIT: B4,
        pub IBIAS_OFFSET: B4,
        pub reserved_24_30: B6,
        pub AMPCOMP_REQ_MODE: B1,
        pub reserved_31_32: B1,
    }

    impl HwRegister for Register {
        const RESERVED_BITS_MASK: u32 = 0xbf000000;
        const READ_ONLY_BITS_MASK: u32 = 0x40ffffff;
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::FCFG1::AMPCOMP_CTRL1", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::FCFG1::AMPCOMP_CTRL1",
