...
pub const DISPLAY: &str = "MODCLKEN0";
...
pub mod AUX_ADI4 {
    ...
    pub mod Named {
        /// System CPU has requested clock for AUX_ADI4
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for AUX_ADI4
        pub const DIS: u32 = 0;
    }
}
...
pub mod AUX_DDI0_OSC {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// System CPU has requested clock for AUX_DDI0_OSC
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for AUX_DDI0_OSC
        pub const DIS: u32 = 0;
    }
}
...
///
///
/// Note that the TDC counter and reference clock sources must be requested separately using TDCCLKCTL and REFCLKCTL, respectively.
pub mod TDC {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    ...
    pub use self::Named as E;
    pub mod Named {
        /// System CPU has requested clock for TDC
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for TDC
        pub const DIS: u32 = 0;
    }
}
...
///
///
/// Note that the ADC internal clock must be requested separately using ADCCLKCTL.
pub mod ANAIF {
    #![allow(clippy::cast_lossless)]
    use core::ops::RangeInclusive;
    ...
    pub use self::Named as E;
    pub mod Named {
        /// System CPU has requested clock for ANAIF
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for ANAIF
        pub const DIS: u32 = 0;
    }
}
...
pub mod TIMER {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// System CPU has requested clock for TIMER
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for TIMER
        pub const DIS: u32 = 0;
    }
}
...
pub mod AIODIO1 {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// System CPU has requested clock for AIODIO1
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for AIODIO1
        pub const DIS: u32 = 0;
    }
}
...
pub mod AIODIO0 {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// System CPU has requested clock for AIODIO0
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for AIODIO0
        pub const DIS: u32 = 0;
    }
}
...
pub mod SMPH {
    ...
    pub use self::Named as E;
    pub mod Named {
        /// System CPU has requested clock for SMPH
        pub const EN: u32 = 1;
        /// System CPU has not requested clock for SMPH
        pub const DIS: u32 = 0;
    }
}
    ...
    impl HwRegister for Register {
        ...
        fn mutate(&mut self, word: u32) {
            ...
            if old_val & Self::RESERVED_BITS_MASK != new_val & Self::RESERVED_BITS_MASK {
                warn!(target: "cc2650_constants::AUX_WUC::MODCLKEN0", "Changing reserved bits of {}", super::DISPLAY);
            }
            // Check if modifies read only bits
            if old_val & Self::READ_ONLY_BITS_MASK != new_val & Self::READ_ONLY_BITS_MASK {
                warn!(
                    target: "cc2650_constants::AUX_WUC::MODCLKEN0",
