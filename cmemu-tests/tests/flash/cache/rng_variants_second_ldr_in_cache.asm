...
dumped_symbols:
  debug_sum: 252 words
  address: 168 words
  COMB_res_number_LEN_4_time_3_LEN_7_time2_LEN_7_time1_LEN_7_time0_LEN_7: 1176 words
  variant_cycles: 84 words
configurations:
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 0, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 1, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 2, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 3, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 4, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 5, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 6, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 0, prefetch: True}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 1, prefetch: True}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 2, prefetch: True}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 3, prefetch: True}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 4, prefetch: True}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 5, prefetch: True}
- { code: "sram", lbEn: true, pull_count: 1024, test_count: 14, test_offset: 64, test_jump: -8, extra_loads: 0, between_ldrs_part: 6, prefetch: True}
...
...
not_next_next_line:
    cmp.w  r12, #2
    bne.w  not_same_set_not_evicted
    sub.w  r6, r5, #2048
    b.w  end_second_ldr_variant
not_same_set_not_evicted:
    cmp.w  r12, #3
    bne.w  not_same_set_evicted
    sub.w  r6, r5, #8192
    b.w    end_second_ldr_variant
not_same_set_evicted:
    cmp.w  r12, #4
    bne.w  not_next_set
    add.w  r6, r5, #2056
    b.w  end_second_ldr_variant
...
end_second_ldr_variant:
    ...
    @ Put the second address in cache
    ldr.w  r10, [r6]
