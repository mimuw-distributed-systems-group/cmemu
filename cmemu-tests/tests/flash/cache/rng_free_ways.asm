...
dumped_symbols:
  debug_sum: 3 words
  address: 2 words
  COMB_res_number_LEN_4_time_3_LEN_7_time2_LEN_7_time1_LEN_7_time0_LEN_7: 64 words
configurations:
- { code: "sram", lbEn: true, pull_count: 129, test_count: 64, test_offset: 128, test_jump: -8, extra_loads: 0, prefetch: False}
- { code: "sram", lbEn: true, pull_count: 129, test_count: 64, test_offset: 128, test_jump: -8, extra_loads: 0, prefetch: True}
...
...
extra_load_loop_end:
    ...
    @ Prepare an address for ldrs with free ways
    add.w  r5, r4, #40
...
test_pull_loop:
    ...
    @ If in the middle, do some ldrs for which there are free ways
    cmp.w  r11, #32
    bne.w  end_free_way_ldrs
    add.w  r6, r5, #8
    add.w  r7, r6, #16
    add.w  r1, r7, #24
    sub.w  r2, r1, #8
