...
configurations:
# MOV tests:
- { code: gpram, lbEn: True, testedInstr: "movs.n" }
- { code: gpram, lbEn: True, testedInstr: "mov.n" }
- { code: gpram, lbEn: True, testedInstr: "mov.w" }
...
# MVN tests:
- { code: gpram, lbEn: True, testedInstr: "mvns.n" }
- { code: gpram, lbEn: True, testedInstr: "mvn.w" }
- { code: gpram, lbEn: True, testedInstr: "mvn.w" }
