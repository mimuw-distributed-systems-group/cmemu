...
configurations:
# wide instruction
- { code: "gpram", lbEn: True, testedInstr: "mul.w", dstReg: "r5", r6Value: "#0x00002DA0", r7Value: "#0x00000480" }
...
- { code: "gpram", lbEn: True, testedInstr: "mul.w", dstReg: "r5", r6Value: "#0x402DF0A0", r7Value: "#0x00000480" }
...
- { code: "gpram", lbEn: True, testedInstr: "mul.w", dstReg: "r5", r6Value: "#0x98395B39", r7Value: "#0x824704EA" }
...
# narrow instruction
- { code: "gpram", lbEn: True, testedInstr: "muls.n", dstReg: "r7", r6Value: "#0x00002DA0", r7Value: "#0x00000480" }
...
- { code: "gpram", lbEn: True, testedInstr: "muls.n", dstReg: "r7", r6Value: "#0x402DF0A0", r7Value: "#0x00000480" }
...
- { code: "gpram", lbEn: True, testedInstr: "muls.n", dstReg: "r7", r6Value: "#0x98395B39", r7Value: "#0x824704EA" }
