...
configurations:
# MOV tests:
- { repetitions: 8, code: gpram, lbEn: True, testedInstr: "movs.n" }
- { repetitions: 16, code: gpram, lbEn: True, testedInstr: "movw.w" }
- { repetitions: 32, code: gpram, lbEn: True, testedInstr: "mov.w" }
...
# MVN tests:
- { repetitions: 32, code: gpram, lbEn: True, testedInstr: "mvns.w" }
- { repetitions: 32, code: gpram, lbEn: True, testedInstr: "mvn.w" }
