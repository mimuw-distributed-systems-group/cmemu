...
dumped_symbols:
  ...
  lsucnts: 4 words
configurations:
- { code: "sram", lbEn: True, memory: "sram", cache_enabled: True }
- { code: "sram", lbEn: True, memory: "flash", cache_enabled: True }
- { code: "sram", lbEn: False, memory: "flash", cache_enabled: True }
- { code: "flash", lbEn: True, memory: "sram", cache_enabled: True }
- { code: "flash", lbEn: False, memory: "sram", cache_enabled: True }
- { code: "flash", lbEn: True, memory: "flash", cache_enabled: True }
- { code: "flash", lbEn: False, memory: "flash", cache_enabled: True }
...
