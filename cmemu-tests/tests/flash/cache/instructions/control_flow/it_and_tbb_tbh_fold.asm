...
dumped_symbols:
  ...
  cpicnts: 80 words
configurations:
- { code: "flash", memory: "sram", lbEn: True, scenario: 1, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: False, scenario: 1, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: True, scenario: 2, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: False, scenario: 2, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: True, scenario: 3, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: False, scenario: 3, cache_enabled: True }
...
