...
dumped_symbols:
  ...
  lsucnts: 20 words
configurations:
- { code: "sram", memory: "sram", lbEn: True, tbInstr: "tbb.w", cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, tbInstr: "tbb.w", cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: True, tbInstr: "tbb.w", cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: True, tbInstr: "tbb.w", cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, tbInstr: "tbb.w", cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: False, tbInstr: "tbb.w", cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: False, tbInstr: "tbb.w", cache_enabled: True }
- { code: "sram", memory: "sram", lbEn: True, tbInstr: "tbh.w", cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, tbInstr: "tbh.w", cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: True, tbInstr: "tbh.w", cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: True, tbInstr: "tbh.w", cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, tbInstr: "tbh.w", cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: False, tbInstr: "tbh.w", cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: False, tbInstr: "tbh.w", cache_enabled: True }
...
