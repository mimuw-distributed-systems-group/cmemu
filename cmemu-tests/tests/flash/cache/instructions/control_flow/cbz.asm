...
dumped_symbols:
  ...
  lsucnts: auto
configurations:
- { code: "sram", lbEn: True, separator: True, cache_enabled: True }
- { code: "sram", lbEn: True, separator: False, cache_enabled: True }
- { code: "flash", lbEn: True, separator: True, cache_enabled: True }
- { code: "flash", lbEn: True, separator: False, cache_enabled: True }
- { code: "flash", lbEn: False, separator: True, cache_enabled: True }
- { code: "flash", lbEn: False, separator: False, cache_enabled: True }
...
