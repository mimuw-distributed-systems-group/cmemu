...
description: Tests LDM.N focusing on pipelining and registers dependency
dumped_symbols:
  ...
  lsucnts: 256 words
configurations:
- { code: "sram", memory: "sram", sram_part: 0, lbEn: True, cache_enabled: True }
- { code: "sram", memory: "sram", sram_part: 1, lbEn: True, cache_enabled: True }
- { code: "sram", memory: "flash", sram_part: 0, lbEn: True, cache_enabled: True }
- { code: "sram", memory: "flash", sram_part: 1, lbEn: True, cache_enabled: True }
- { code: "sram", memory: "flash", sram_part: 0, lbEn: False, cache_enabled: True }
- { code: "sram", memory: "flash", sram_part: 1, lbEn: False, cache_enabled: True }
