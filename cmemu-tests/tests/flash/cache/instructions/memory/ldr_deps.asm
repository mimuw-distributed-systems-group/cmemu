...
dumped_symbols:
  ...
  lsucnts: 17 words
configurations:
- { code: "sram", addr: "sram", lbEn: True, cache_enabled: True }
- { code: "sram", addr: "flash", lbEn: True, cache_enabled: True }
- { code: "sram", addr: "flash", lbEn: False, cache_enabled: True }
- { code: "flash", addr: "sram", lbEn: True, cache_enabled: True }
- { code: "flash", addr: "sram", lbEn: False, cache_enabled: True }
- { code: "flash", addr: "flash", lbEn: True, cache_enabled: True }
- { code: "flash", addr: "flash", lbEn: False, cache_enabled: True }
...
