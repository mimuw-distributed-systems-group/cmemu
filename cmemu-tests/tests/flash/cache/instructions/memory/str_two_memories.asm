...
dumped_symbols:
  times: 30 words
configurations:
- { code: "sram", addr0: "sram", addr1: "sram", strInstr: "str.w", cache_enabled: True }
- { code: "sram", addr0: "sram", addr1: "sram", strInstr: "str.n", cache_enabled: True }
- { code: "flash", addr0: "sram", addr1: "sram", strInstr: "str.w", cache_enabled: True }
- { code: "flash", addr0: "sram", addr1: "sram", strInstr: "str.n", cache_enabled: True }
...
