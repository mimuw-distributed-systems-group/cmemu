...
dumped_symbols:
  ...
  lsucnts: 426 words
configurations:
- { code: "sram", memory: "sram", lbEn: True, part: 0, cache_enabled: True }
- { code: "sram", memory: "sram", lbEn: True, part: 1, cache_enabled: True }
- { code: "sram", memory: "sram", lbEn: True, part: 2, cache_enabled: True }
- { code: "sram", memory: "sram", lbEn: True, part: 3, cache_enabled: True }
- { code: "sram", memory: "sram", lbEn: True, part: 4, cache_enabled: True }
- { code: "sram", memory: "sram", lbEn: True, part: 5, cache_enabled: True }
- { code: "sram", memory: "sram", lbEn: True, part: 6, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, part: 0, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, part: 1, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, part: 2, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, part: 3, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, part: 4, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, part: 5, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: True, part: 6, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, part: 0, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, part: 1, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, part: 2, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, part: 3, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, part: 4, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, part: 5, cache_enabled: True }
- { code: "sram", memory: "flash", lbEn: False, part: 6, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: True, part: 0, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: True, part: 1, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: False, part: 0, cache_enabled: True }
- { code: "flash", memory: "sram", lbEn: False, part: 1, cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: True, part: 0, cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: True, part: 1, cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: False, part: 0, cache_enabled: True }
- { code: "flash", memory: "flash", lbEn: False, part: 1, cache_enabled: True }
...
...
{% set test_parts = {"gpram": 5, "sram": 7, "flash": 2}[code] %}
