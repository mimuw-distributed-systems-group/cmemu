...
description: 'Test flow: (conf. 0) label506 -> label128'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
- code_memory: flash
  ...
  wb_en: false
  jump_start: label506
  jump_label506: label128
  jump_label128: code_end
  code_end: code_end
  space_mod: 4
...
...
.align	2
.space	1, 45
.space 15543 % {{space_mod|default("0x10000000")}}
label128:
	sub	r13, #20  @ 2b  @ 2b  @ 2b  @ 2b  @ 2b  @ 2b
	str	r9, [r13]                     @ A7.7.161  @ 4b @ looks important!  @ 4b @ looks important!  @ 4b  @ 4b  @ 4b  @ 4b
nop.n  @ 2b @ looks important!  @ 2b @ looks important!  @ 2b @ looks important!  @ 2b @ looks important!
.space 36  @ 36b @ looks important!  @ 36b @ looks important!  @ 36b @ looks important!
	sub	r6, r13, #201                 @ A7.7.176  @ 4b  @ 4b  @ 4b  @ 4b  @ 4b  @ 4b
.space 22 + 2 + 12 + 2  @ 38b  @ 38b  @ 38b  @ 38b
end_label128:
	b.w	{{jump_label128}}
...
.align	2
.space	1, 45
.space 935 % {{space_mod|default("0x10000000")}}

.align	1
.space 3648 % {{space_mod|default("0x10000000")}}
label506:
.space 90  @ 90b  @ 90b  @ 90b
end_label506:
	b.w	{{jump_label506}}
...
.align	1
.space 14462 % {{space_mod|default("0x10000000")}}
end_label625:
	b.w	{{code_end}}
