...
description: 'Test flow: (conf. 0) label525 -> label277'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
- code_memory: flash
  ...
  wb_en: false
  jump_start: label525
  jump_label525: label277
  jump_label277: code_end
  code_end: code_end
  space_mod: 4
...
...
.align	1
.space 52 % {{space_mod|default("0x10000000")}}
end_label1:
	b.w	{{code_end}}
...
.align	2
.space	1, 45
.space 35711 % {{space_mod|default("0x10000000")}}
label277: @ looks important! @ looks important!
	cbnz	r2, forward_label_459         @ A7.7.21  @ 2b @ looks important!  @ 2b @ looks important!  @ 2b @ looks important!
 @ looks important!
.space 34 
	strh	r2, [r13, #21]                @ A7.7.170  @ 4b  @ 4b  @ 4b
.space 24   @ 24b

forward_label_459:
.space 2  @ 2b  @ 2b
	ldrsb	r10, [r13, #-21]              @ A7.7.59  @ 4b  @ 4b  @ 4b
	nop.n  @ was .align 2  @ 2b @ looks important!
.space 26   @ 26b @ looks important!
end_label277:
	b.w	{{jump_label277}}
...
.align	2
.space 161 % {{space_mod|default("0x10000000")}}

.align	1
.space 2869 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	0, 46
.space 214 % {{space_mod|default("0x10000000")}}


{% if not cache_en %}{{section('gpram')}}{% else %}{{section('sram')}}{% endif %}
.align  2
.space	3, 46
.space 147 % {{space_mod|default("0x10000000")}}
