...
description: 'Test flow: (conf. 0) label229'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
.align	2
.space	0, 45
.space 12528 % {{space_mod|default("0x10000000")}}
label229:
.space 12   @ 12b
	ldrd	r8, r10, cell_1307            @ A7.7.51  @ 4b  @ 4b @ looks important!
.space 20 
ldr	r3, cell_1304  @ 4b  @ 4b
.space 8   @ 8b
mov	r9, #61043  @ 4b  @ 4b
.space 12   @ 12b
ldr	r2, cell_1303  @ 4b  @ 4b
.space 4  @ 4b
mov	r0, #14685  @ 4b  @ 4b
.space 16  @ 16b
	ittet	ge  @ 2b  @ 2b
	umullge	r10, r4, r9, r8               @ A7.7.204 @ 4b @ 4b
	mrsge	r0, apsr                      @ A7.7.82 @ 4b @ 4b
	strblt	r0, [r3, r0]                  @ A7.7.164 @ 2b @ 2b
	ldrbge	r9, [r2]                      @ A7.7.46 @ 4b @ looks important! @ 4b @ looks important!
 @ looks important!
end_label229:
	b.w	{{jump_label229}}
...
.align	2
.global	cell_1307
cell_1307:	.quad	0x75ea7e8e1e2415fd

.space	3, 45
.space 7 % {{space_mod|default("0x10000000")}}
.global	cell_1303
cell_1303:	.word	safeSpaceSram+855

.space	3, 45
.global	cell_1304
cell_1304:	.word	safeSpaceSram-14510

.align	2
.space 8 % {{space_mod|default("0x10000000")}}

.align	1
.space 23458 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	1, 46
.space 262 % {{space_mod|default("0x10000000")}}
