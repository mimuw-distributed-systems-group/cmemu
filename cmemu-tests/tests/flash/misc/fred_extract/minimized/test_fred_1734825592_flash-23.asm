...
description: 'Test flow: (conf. 0) label619 -> label5'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
- code_memory: flash
  ...
  wb_en: false
  jump_start: label619
  jump_label619: label5
  jump_label5: code_end
  code_end: code_end
  space_mod: 4
...
...
.align	2
.space	1, 45
.space 463 % {{space_mod|default("0x10000000")}}
label5:
	sub	r13, #28  @ 2b  @ 2b  @ 2b
	strb	r7, [r13], #28                @ A7.7.163  @ 4b @ looks important!  @ 4b  @ 4b
	nop.n  @ was .align 2  @ 2b @ looks important!
.space 4  @ 4b  @ 4b
mov	r8, #8  @ 4b  @ 4b  @ 4b
	str	r1, [r13, r8, LSL #3]         @ A7.7.162  @ 4b  @ 4b  @ 4b
.space 12   @ 12b  @ 12b
mov	r2, #6  @ 4b  @ 4b  @ 4b
.space 14   @ 14b  @ 14b
	ldrsb	r0, [r13, r2, LSL #1]         @ A7.7.61  @ 4b  @ 4b  @ 4b
.space 12   @ 12b  @ 12b
end_label5:
	b.w	{{jump_label5}}
...
.align	1
.space 677 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	1, 46
.space 328 % {{space_mod|default("0x10000000")}}


{% if not cache_en %}{{section('gpram')}}{% else %}{{section('sram')}}{% endif %}
.align  2
.space	3, 46
.space 294 % {{space_mod|default("0x10000000")}}
