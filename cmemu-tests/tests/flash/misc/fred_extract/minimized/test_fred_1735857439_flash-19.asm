...
description: 'Test flow: (conf. 0) label288 -> label75'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
- code_memory: flash
  ...
  wb_en: false
  jump_start: label288
  jump_label288: label75
  jump_label75: code_end
  code_end: code_end
  space_mod: 8
...
...
.align	2
.space	0, 45
.space 9816 % {{space_mod|default("0x10000000")}}
label75:
	sub	r13, #84  @ 2b  @ 2b
.space 2  @ 2b
	str	r6, [r13]                     @ A7.7.161  @ 2b  @ 2b
	nop.n  @ was .align 2  @ 2b @ looks important!
	ldrd	r5, r8, cell_293              @ A7.7.51  @ 4b @ looks important!  @ 4b @ looks important!
.space 6   @ 6b
	ldrd	r10, r5, [r13], #84           @ A7.7.50  @ 4b  @ 4b
.space 10   @ 10b
end_label75:
	b.w	{{jump_label75}}
...
.align	2
.global	cell_293
cell_293:	.quad	0x7b9107aedc884fc4

.align	1
.space 28628 % {{space_mod|default("0x10000000")}}
label288:
.space 54 
end_label288:
	b.w	{{jump_label288}}
...
.align	1
.space 41629 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	3, 46
.space 387 % {{space_mod|default("0x10000000")}}
