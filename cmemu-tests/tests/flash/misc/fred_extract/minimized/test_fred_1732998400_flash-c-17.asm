...
description: 'Test flow: (conf. 0) label571'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
.align	2
.space	1, 45
.space 33159 % {{space_mod|default("0x10000000")}}
label571:
ldr	r6, cell_3602  @ 4b  @ 4b
ldr	r2, cell_3601  @ 4b  @ 4b
	ite	cc  @ 2b  @ 2b
	cmncc	r0, r7                        @ A7.7.26 @ 2b @ 2b
	strdcs	r9, r0, [r2]                  @ A7.7.166 @ 4b @ looks important! @ 4b @ looks important!
 @ looks important!
 @ looks important!
 @ looks important! @ looks important!
	cbnz	r1, forward_label_1055        @ A7.7.21  @ 2b @ looks important!  @ 2b @ looks important!

.space 40 
forward_label_1055:
	strh	r4, [r6], #-52                @ A7.7.170  @ 4b @ looks important!  @ 4b @ looks important!
...
.space	2, 45
.global	cell_3602
cell_3602:	.word	safeSpaceSram+306

.space	3, 45
.space 5 % {{space_mod|default("0x10000000")}}
.global	cell_3601
cell_3601:	.word	safeSpaceGpramSram+64

.align	1
.space 2570 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	1, 46
.space 258 % {{space_mod|default("0x10000000")}}


{% if not cache_en %}{{section('gpram')}}{% else %}{{section('sram')}}{% endif %}
.align  2
.space	2, 46
.space 182 % {{space_mod|default("0x10000000")}}
