...
.ltorg
.align	2
.space 4218 % {{space_mod|default("0x10000000")}}
label95:
	orr	r1, r5, #40                   @ A7.7.91  @ 4b @ looks important!  @ 4b @ looks important!
	umull	r3, r1, r6, r0                @ A7.7.204  @ 4b @ looks important!  @ 4b @ looks important!
	mla	r6, r3, r6, r1                @ A7.7.74  @ 4b @ looks important!  @ 4b @ looks important!
	mla	r9, r1, r3, r6                @ A7.7.74  @ 4b @ looks important!  @ 4b @ looks important!
ldr	r2, cell_371  @ 2b  @ 2b @ looks important!
.space 28   @ 28b @ looks important!
end_label95:
	b.w	{{jump_label95}}
...
.global	cell_371
cell_371:	.word	safeSpaceSram+564

.align	1
.space 25494 % {{space_mod|default("0x10000000")}}
end_label625:
	b.w	{{code_end}}
...
.align  2
.space	3, 46
.space 140 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	1, 46
.space 230 % {{space_mod|default("0x10000000")}}
