...
description: 'Test flow: (conf. 0) label466'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
.align	2
.space	2, 45
.space 67782 % {{space_mod|default("0x10000000")}}
label466:
ldr	r5, cell_2834  @ 4b
mov	r3, #43748  @ 4b
.space 6 
	adr	r6, cell_2833                 @ A7.7.7  @ 4b
	tst	r8, r8, LSL #2                @ A7.7.189  @ 4b
.space 2
	smull	r3, r0, r0, r6                @ A7.7.149  @ 4b @ looks important!
	mla	r2, r10, r10, r0              @ A7.7.74  @ 4b @ looks important!
	mla	r4, r3, r10, r2               @ A7.7.74  @ 4b @ looks important!
ldr	r9, cell_2832  @ 4b @ looks important!
mov	r0, #59  @ 4b
.space 32 
end_label466:
	b.w	{{jump_label466}}
...
.space	2, 45
.global	cell_2832
cell_2832:	.word	safeSpaceGpramSram+213
...
.space	1, 45
.global	cell_2834
cell_2834:	.word	safeSpaceFlash-42833

.space	2, 45
.space 1 % {{space_mod|default("0x10000000")}}

.align	1
.space 8492 % {{space_mod|default("0x10000000")}}
