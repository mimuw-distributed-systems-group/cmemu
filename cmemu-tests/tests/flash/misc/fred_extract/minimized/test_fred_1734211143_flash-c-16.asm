...
description: 'Test flow: (conf. 0) label51'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
.align	2
.space	1, 45
.space 3657 % {{space_mod|default("0x10000000")}}
label51:
.space 10   @ 10b
ldr	r9, cell_364  @ 4b  @ 4b
	isb	                              @ A7.7.37  @ 4b @ looks important!  @ 4b @ looks important!
	it	ge  @ 2b  @ 2b
	ldrbge	r1, [r9, #650]                @ A7.7.46 @ 4b @ looks important! @ 4b @ looks important!
 @ looks important!
...
.global	cell_364
cell_364:	.word	safeSpaceSram+86

.space	3, 45
.space 1 % {{space_mod|default("0x10000000")}}

.align	1
.space 33492 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	0, 46
.space 260 % {{space_mod|default("0x10000000")}}


{{section('sram')}}
.align  2
.space	3, 46
.space 266 % {{space_mod|default("0x10000000")}}
