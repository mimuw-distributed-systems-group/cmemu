...
description: 'Test flow: (conf. 0) label517'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
.align	2
.space	0, 45
.space 31998 % {{space_mod|default("0x10000000")}}
label517:
ldr	r2, cell_3552  @ 2b
mov	r6, #2  @ 4b
	ite	cs  @ 2b
	cmncs	r4, r8, LSL #2                @ A7.7.26 @ 4b
	bcc	forward_label_956             @ A7.7.12 @ 2b @ looks important!
 @ looks important!
...
mov	r9, #27  @ 4b
.space 6   @ 6b
	str	r9, [r13, r9]                 @ A7.7.162  @ 4b
.space 12   @ 12b
	stmdb	r13, {r0-r9}                  @ A7.7.160  @ 4b

forward_label_956:
	ldrsb	r3, [r13, r6, LSL #2]         @ A7.7.61  @ 4b
	nop.n  @ was .align 2  @ 2b @ looks important!
	ldrd	r5, r4, cell_3549             @ A7.7.51 @ 4b @ looks important!  @ 4b @ looks important!
	ite	mi  @ 2b
	ldrbmi	r2, [r13]                     @ A7.7.46 @ 4b
	ldrhpl	r5, [r2, #812]                @ A7.7.55 @ 4b
.space 4  @ 4b
end_label517:
	b.w	{{jump_label517}}
...
.global	cell_3552
cell_3552:	.word	safeSpaceFlash-363

.align	2
.global	cell_3549
cell_3549:	.quad	0x0f2ba4301d4872e2

.space	3, 45
.space 2 % {{space_mod|default("0x10000000")}}

.align	1
.space 5646 % {{space_mod|default("0x10000000")}}
...
.align  2
.space	3, 46
.space 215 % {{space_mod|default("0x10000000")}}


{% if not cache_en %}{{section('gpram')}}{% else %}{{section('sram')}}{% endif %}
.align  2
.space	0, 46
.space 216 % {{space_mod|default("0x10000000")}}
