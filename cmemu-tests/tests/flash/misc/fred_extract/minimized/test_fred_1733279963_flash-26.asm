...
description: 'Test flow: (conf. 0) label209 -> label350'
dumped_symbols:
  counters: 7 words
  registers: 77 words
  stack: user-defined
...
- code_memory: flash
  ...
  wb_en: false
  jump_start: label209
  jump_label209: label350
  jump_label350: code_end
  code_end: code_end
...
...
.align	2
.space	2, 45
.space 29800 % {{space_mod|default("0x10000000")}}
label209:
.space 12 
...
.align	1
.space 20408 % {{space_mod|default("0x10000000")}}
label350:
	sub	r13, #204  @ 2b  @ 2b  @ 2b
	ldrsh	r7, [r13, #204]!              @ A7.7.63  @ 4b  @ 4b @ looks important!  @ 4b @ looks important!
	nop.n  @ was .align 2  @ 2b @ looks important!
.space 4  @ 4b
	strb	r10, [r13]                    @ A7.7.163  @ 4b  @ 4b  @ 4b
.space 4  @ 4b  @ 4b
mov	r9, #13  @ 4b  @ 4b  @ 4b
.space 2  @ 2b  @ 2b
	ldr	r7, [r13, r9]                 @ A7.7.45  @ 4b  @ 4b  @ 4b
	ldm	r13, {r2,r8}                  @ A7.7.41  @ 4b  @ 4b  @ 4b
.space 2  @ 2b  @ 2b
	strd	r4, r8, [r13, #-8]            @ A7.7.166  @ 4b  @ 4b  @ 4b
.space 16   @ 16b  @ 16b
	cmp	r13, #187                     @ A7.7.27  @ 4b  @ 4b  @ 4b
.space 4  @ 4b  @ 4b
	ldrsh	r1, [r13]                     @ A7.7.63  @ 4b  @ 4b  @ 4b
.space 4  @ 4b  @ 4b
end_label350:
	b.w	{{jump_label350}}
...
.align	1
.space 40167 % {{space_mod|default("0x10000000")}}
