...
configurations:
# Scenario #1:
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "", bInstr: "b.n", skippedInstr: "it.n eq; addeq.n r7, r7" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "add.n r7, r7", bInstr: "b.n", skippedInstr: "it.n eq; addeq.n r7, r7" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "mov.w r7, #0", bInstr: "cbz.n r7,", skippedInstr: "it.n eq; addeq.n r7, r7" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "mov.w r7, #0", bInstr: "cbnz.n r7,", skippedInstr: "it.n eq; addeq.n r7, r7" }
...
# Scenario #2:
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "it.n eq; addeq.n r7, r7", bInstr: "b.n", skippedInstr: "" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "it.n eq; addeq.n r7, r7", bInstr: "b.n", skippedInstr: "add.n r7, r7" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "it.n eq; addeq.n r7, r7; mov.w r7, #0", bInstr: "cbz.n r7,", skippedInstr: "" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "it.n eq; addeq.n r7, r7; mov.w r7, #0", bInstr: "cbnz.n r7,", skippedInstr: "" }
...
# Scenario #3:
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "movs.n r7, #0; it.n eq", bInstr: "beq.n", skippedInstr: "" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "movs.n r7, #0; it.n ne", bInstr: "bne.n", skippedInstr: "" }
# Is it instruction folded after skipped/executed decode time branch?
- { code: "gpram", lbEn: true, initInstr: "movs.n r7, #0", preInstr: "it.n eq", bInstr: "beq.n", skippedInstr: "" }
- { code: "gpram", lbEn: true, initInstr: "movs.n r7, #0", preInstr: "it.n ne", bInstr: "bne.n", skippedInstr: "" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "movs.n r7, #0; it.n eq", bInstr: "beq.n", skippedInstr: "add.w r8, #1" }
- { code: "gpram", lbEn: true, initInstr: "", preInstr: "movs.n r7, #0; it.n ne", bInstr: "bne.n", skippedInstr: "add.w r8, #1" }
