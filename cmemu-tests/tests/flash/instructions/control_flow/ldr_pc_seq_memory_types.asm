...
- lbEn: False
  allCodePlaces:
  - ["flash", "flash", "flash", "sram", "gpram", "flash", "flash", "flash"]
  - ["sram", "gpram", "gpram", "flash", "gpram", "gpram", "gpram", "gpram"]
  - ["gpram", "sram", "gpram", "flash", "gpram", "sram", "flash", "sram"]
  - ["gpram", "sram", "flash", "sram", "gpram", "sram", "flash", "flash"]
  - ["gpram", "gpram", "sram", "gpram", "gpram", "gpram", "sram", "sram"]
  - ["flash", "sram", "sram", "flash", "sram", "gpram", "gpram", "sram"]
  - ["gpram", "flash", "sram", "flash", "gpram", "flash", "flash", "flash"]
  - ["gpram", "sram", "flash", "flash", "flash", "flash", "gpram", "flash"]
  - ["gpram", "gpram", "gpram", "gpram", "gpram", "flash", "sram", "flash"]
  - ["sram", "flash", "sram", "sram", "flash", "flash", "flash", "gpram"]
  - ["sram", "flash", "sram", "flash", "sram", "sram", "flash", "sram"]
  - ["sram", "sram", "flash", "gpram", "gpram", "sram", "gpram", "flash"]
