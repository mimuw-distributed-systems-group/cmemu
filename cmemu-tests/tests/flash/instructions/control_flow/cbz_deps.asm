...
dumped_symbols:
  ...
  foldcnts: 24 words
configurations:
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "ldr.w r5, [r1]", cbzInstr: "cbz.n" }
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "str.w r5, [r1]", cbzInstr: "cbz.n" }
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "ldr.w r7, [r1]", cbzInstr: "cbnz.n" }
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "str.w r7, [r1]", cbzInstr: "cbz.n" }
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "adds.n r7, r5", cbzInstr: "cbnz.n" }
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "adds.w r7, r5", cbzInstr: "cbnz.n" }
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "nop.n", cbzInstr: "cbz.n" }
- { code: "gpram", lbEn: true, addr: "sram", preInstr: "nop.w", cbzInstr: "cbz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "ldr.w r5, [r1]", cbzInstr: "cbz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "str.w r5, [r1]", cbzInstr: "cbz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "ldr.w r7, [r1]", cbzInstr: "cbnz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "str.w r7, [r1]", cbzInstr: "cbz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "adds.n r7, r5", cbzInstr: "cbnz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "adds.w r7, r5", cbzInstr: "cbnz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "nop.n", cbzInstr: "cbz.n" }
- { code: "sram", lbEn: true, addr: "gpram", preInstr: "nop.w", cbzInstr: "cbz.n" }
