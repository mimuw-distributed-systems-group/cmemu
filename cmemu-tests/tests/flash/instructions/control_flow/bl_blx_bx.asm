...
# bl tests
# mov lr
- { code: "gpram", lbEn: true, instr: "bl.w", saveLRInstr: "mov.w  lr, r8" }
...
# umull lr, rx
- { code: "gpram", lbEn: true, instr: "bl.w", saveLRInstr: "umull.w lr, r10, r8, r9" }
...
# umull rx, lr
- { code: "gpram", lbEn: true, instr: "bl.w", saveLRInstr: "umull.w r10, lr, r8, r9" }
...
# umull ry, rx
- { code: "gpram", lbEn: true, instr: "bl.w", saveLRInstr: "umull.w r10, r11, r8, r9" }
...
# blx tests
# mov lr
- { code: "gpram", lbEn: true, instr: "blx.n", saveLRInstr: "mov.w  lr, r8" }
...
# umull lr, rx
- { code: "gpram", lbEn: true, instr: "blx.n", saveLRInstr: "umull.w lr, r10, r8, r9" }
...
# umull rx, lr
- { code: "gpram", lbEn: true, instr: "blx.n", saveLRInstr: "umull.w r10, lr, r8, r9" }
...
# umull ry, rx
- { code: "gpram", lbEn: true, instr: "blx.n", saveLRInstr: "umull.w r10, r11, r8, r9" }
