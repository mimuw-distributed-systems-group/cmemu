...
configurations:
# TBB
- { code: "gpram", memory: "gpram", lbEn: True, tbInstr: "tbb.w" }
- { code: "gpram", memory: "sram", lbEn: True, tbInstr: "tbb.w" }
- { code: "gpram", memory: "flash", lbEn: True, tbInstr: "tbb.w" }
- { code: "sram", memory: "gpram", lbEn: True, tbInstr: "tbb.w" }
- { code: "sram", memory: "sram", lbEn: True, tbInstr: "tbb.w" }
- { code: "sram", memory: "flash", lbEn: True, tbInstr: "tbb.w" }
- { code: "flash", memory: "gpram", lbEn: True, tbInstr: "tbb.w" }
- { code: "flash", memory: "sram", lbEn: True, tbInstr: "tbb.w" }
- { code: "flash", memory: "flash", lbEn: True, tbInstr: "tbb.w" }
- { code: "gpram", memory: "flash", lbEn: False, tbInstr: "tbb.w" }
- { code: "sram", memory: "flash", lbEn: False, tbInstr: "tbb.w" }
- { code: "flash", memory: "gpram", lbEn: False, tbInstr: "tbb.w" }
- { code: "flash", memory: "sram", lbEn: False, tbInstr: "tbb.w" }
- { code: "flash", memory: "flash", lbEn: False, tbInstr: "tbb.w" }
# TBH
- { code: "gpram", memory: "gpram", lbEn: True, tbInstr: "tbh.w" }
- { code: "gpram", memory: "sram", lbEn: True, tbInstr: "tbh.w" }
- { code: "gpram", memory: "flash", lbEn: True, tbInstr: "tbh.w" }
- { code: "sram", memory: "gpram", lbEn: True, tbInstr: "tbh.w" }
- { code: "sram", memory: "sram", lbEn: True, tbInstr: "tbh.w" }
- { code: "sram", memory: "flash", lbEn: True, tbInstr: "tbh.w" }
- { code: "flash", memory: "gpram", lbEn: True, tbInstr: "tbh.w" }
- { code: "flash", memory: "sram", lbEn: True, tbInstr: "tbh.w" }
- { code: "flash", memory: "flash", lbEn: True, tbInstr: "tbh.w" }
- { code: "gpram", memory: "flash", lbEn: False, tbInstr: "tbh.w" }
- { code: "sram", memory: "flash", lbEn: False, tbInstr: "tbh.w" }
- { code: "flash", memory: "gpram", lbEn: False, tbInstr: "tbh.w" }
