...
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 0 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 1 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 2 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 3 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 4 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 5 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 6 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 7 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 8 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 9 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 10 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 11 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 12 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 13 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 14 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 15 }
- { code: "gpram", lbEn: false, cacheEn: false, gpram_part: 16 }

- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 0 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 1 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 2 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 3 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 4 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 5 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 6 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 7 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 8 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 9 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 10 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 11 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 12 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 13 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 14 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 15 }
- { code: "gpram", lbEn: true, cacheEn: false, gpram_part: 16 }
...
tested_code:
{% for dataMem in ["flash", "gpram", "sram"] if dataMem != "gpram" or not cacheEn %}
{% for dataAlign in ["aligned", "unaligned"] %}
{% for tableMem in ["flash", "gpram", "sram"] if tableMem != "gpram" or not cacheEn %}
...
{% for memory in ["flash", "gpram", "sram"] if memory != "gpram" or not cacheEn %}
    {{ section(memory) }}
    .align  2
