...
dumped_symbols:
  ...
  lsucnts: 64 words
configurations:
- { code: gpram, ldrMemory: gpram, strMemory: gpram, lbEn: True }
- { code: gpram, ldrMemory: gpram, strMemory: sram, lbEn: True }
- { code: gpram, ldrMemory: sram, strMemory: gpram, lbEn: True }
- { code: gpram, ldrMemory: sram, strMemory: sram, lbEn: True }
- { code: gpram, ldrMemory: flash, strMemory: gpram, lbEn: True }
- { code: gpram, ldrMemory: flash, strMemory: gpram, lbEn: False }
- { code: gpram, ldrMemory: flash, strMemory: sram, lbEn: True }
- { code: gpram, ldrMemory: flash, strMemory: sram, lbEn: False }
- { code: sram, ldrMemory: gpram, strMemory: gpram, lbEn: True }
- { code: sram, ldrMemory: gpram, strMemory: sram, lbEn: True }
- { code: sram, ldrMemory: sram, strMemory: gpram, lbEn: True }
- { code: sram, ldrMemory: sram, strMemory: sram, lbEn: True }
- { code: sram, ldrMemory: flash, strMemory: gpram, lbEn: True }
- { code: sram, ldrMemory: flash, strMemory: gpram, lbEn: False }
- { code: sram, ldrMemory: flash, strMemory: sram, lbEn: True }
- { code: sram, ldrMemory: flash, strMemory: sram, lbEn: False }
- { code: flash, ldrMemory: gpram, strMemory: gpram, lbEn: True }
- { code: flash, ldrMemory: gpram, strMemory: gpram, lbEn: False }
- { code: flash, ldrMemory: gpram, strMemory: sram, lbEn: True }
- { code: flash, ldrMemory: gpram, strMemory: sram, lbEn: False }
- { code: flash, ldrMemory: sram, strMemory: gpram, lbEn: True }
- { code: flash, ldrMemory: sram, strMemory: gpram, lbEn: False }
- { code: flash, ldrMemory: sram, strMemory: sram, lbEn: True }
- { code: flash, ldrMemory: sram, strMemory: sram, lbEn: False }
- { code: flash, ldrMemory: flash, strMemory: gpram, lbEn: True }
- { code: flash, ldrMemory: flash, strMemory: gpram, lbEn: False }
...
{{ section("gpram")}}
.align 4
mem_gpram_0: .word 0xCAFE
.align 4
mem_gpram_1: .word 0xBEE5
