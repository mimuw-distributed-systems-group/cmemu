...
dumped_symbols:
  ...
  str_res_hi: auto
configurations:
- { code: gpram, strMemory: gpram, lbEn: True,  ldrMemory: gpram, part: 0}
- { code: gpram, strMemory: sram,  lbEn: True,  ldrMemory: gpram, part: 0}
- { code: gpram, strMemory: gpram, lbEn: True,  ldrMemory: sram,  part: 0}
- { code: gpram, strMemory: sram,  lbEn: True,  ldrMemory: sram,  part: 0}
- { code: gpram, strMemory: gpram, lbEn: True,  ldrMemory: flash, part: 0}
- { code: gpram, strMemory: sram,  lbEn: True,  ldrMemory: flash, part: 0}
- { code: gpram, strMemory: gpram, lbEn: False, ldrMemory: flash, part: 0}
- { code: gpram, strMemory: sram,  lbEn: False, ldrMemory: flash, part: 0}
- { code: gpram, strMemory: gpram, lbEn: True,  ldrMemory: flash, part: 1}
- { code: gpram, strMemory: sram,  lbEn: True,  ldrMemory: flash, part: 1}
- { code: gpram, strMemory: gpram, lbEn: False, ldrMemory: flash, part: 1}
- { code: gpram, strMemory: sram,  lbEn: False, ldrMemory: flash, part: 1}

- { code: sram,  strMemory: gpram, lbEn: True,  ldrMemory: gpram, part: 0}
- { code: sram,  strMemory: sram,  lbEn: True,  ldrMemory: gpram, part: 0}
- { code: sram,  strMemory: gpram, lbEn: True,  ldrMemory: sram,  part: 0}
- { code: sram,  strMemory: sram,  lbEn: True,  ldrMemory: sram,  part: 0}
- { code: sram,  strMemory: gpram, lbEn: True,  ldrMemory: flash, part: 0}
- { code: sram,  strMemory: sram,  lbEn: True,  ldrMemory: flash, part: 0}
- { code: sram,  strMemory: gpram, lbEn: False, ldrMemory: flash, part: 0}
- { code: sram,  strMemory: sram,  lbEn: False, ldrMemory: flash, part: 0}
- { code: sram,  strMemory: gpram, lbEn: True,  ldrMemory: flash, part: 1}
- { code: sram,  strMemory: sram,  lbEn: True,  ldrMemory: flash, part: 1}
- { code: sram,  strMemory: gpram, lbEn: False, ldrMemory: flash, part: 1}
- { code: sram,  strMemory: sram,  lbEn: False, ldrMemory: flash, part: 1}

- { code: flash, strMemory: gpram, lbEn: True,  ldrMemory: gpram, part: 0}
- { code: flash, strMemory: sram,  lbEn: True,  ldrMemory: gpram, part: 0}
- { code: flash, strMemory: gpram, lbEn: True,  ldrMemory: sram,  part: 0}
- { code: flash, strMemory: sram,  lbEn: True,  ldrMemory: sram,  part: 0}
- { code: flash, strMemory: gpram, lbEn: False, ldrMemory: gpram, part: 0}
- { code: flash, strMemory: sram,  lbEn: False, ldrMemory: gpram, part: 0}
- { code: flash, strMemory: gpram, lbEn: False, ldrMemory: sram,  part: 0}
- { code: flash, strMemory: sram,  lbEn: False, ldrMemory: sram,  part: 0}
- { code: flash, strMemory: gpram, lbEn: True,  ldrMemory: flash, part: 0}
- { code: flash, strMemory: sram,  lbEn: True,  ldrMemory: flash, part: 0}
- { code: flash, strMemory: gpram, lbEn: False, ldrMemory: flash, part: 0}
- { code: flash, strMemory: sram,  lbEn: False, ldrMemory: flash, part: 0}
- { code: flash, strMemory: gpram, lbEn: True,  ldrMemory: flash, part: 1}
- { code: flash, strMemory: sram,  lbEn: True,  ldrMemory: flash, part: 1}
- { code: flash, strMemory: gpram, lbEn: False, ldrMemory: flash, part: 1}
