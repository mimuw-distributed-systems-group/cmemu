...
- { code: gpram, data: gpram, lbEn: true, instr: ldm, part: 0 }
- { code: gpram, data: gpram, lbEn: true, instr: ldm, part: 1 }
- { code: gpram, data: gpram, lbEn: true, instr: ldm, part: 2 }
- { code: sram, data: gpram, lbEn: true, instr: ldm, part: 0 }
- { code: sram, data: gpram, lbEn: true, instr: ldm, part: 1 }
- { code: flash, data: gpram, lbEn: true, instr: ldm }
- { code: flash, data: gpram, lbEn: false, instr: ldm }

- { code: gpram, data: sram, lbEn: true, instr: ldm, part: 0 }
- { code: gpram, data: sram, lbEn: true, instr: ldm, part: 1 }
- { code: gpram, data: sram, lbEn: true, instr: ldm, part: 2 }
...
- { code: gpram, data: flash, lbEn: true, instr: ldm, part: 0 }
- { code: gpram, data: flash, lbEn: true, instr: ldm, part: 1 }
- { code: gpram, data: flash, lbEn: true, instr: ldm, part: 2 }
- { code: gpram, data: flash, lbEn: false, instr: ldm, part: 0 }
- { code: gpram, data: flash, lbEn: false, instr: ldm, part: 1 }
- { code: gpram, data: flash, lbEn: false, instr: ldm, part: 2 }
...
- { code: gpram, data: gpram, lbEn: true, instr: ldmdb, part: 0 }
- { code: gpram, data: gpram, lbEn: true, instr: ldmdb, part: 1 }
- { code: gpram, data: gpram, lbEn: true, instr: ldmdb, part: 2 }
- { code: sram, data: gpram, lbEn: true, instr: ldmdb, part: 0 }
- { code: sram, data: gpram, lbEn: true, instr: ldmdb, part: 1 }
- { code: flash, data: gpram, lbEn: true, instr: ldmdb }
- { code: flash, data: gpram, lbEn: false, instr: ldmdb }

- { code: gpram, data: sram, lbEn: true, instr: ldmdb, part: 0 }
- { code: gpram, data: sram, lbEn: true, instr: ldmdb, part: 1 }
- { code: gpram, data: sram, lbEn: true, instr: ldmdb, part: 2 }
...
- { code: gpram, data: flash, lbEn: true, instr: ldmdb, part: 0 }
- { code: gpram, data: flash, lbEn: true, instr: ldmdb, part: 1 }
- { code: gpram, data: flash, lbEn: true, instr: ldmdb, part: 2 }
- { code: gpram, data: flash, lbEn: false, instr: ldmdb, part: 0 }
- { code: gpram, data: flash, lbEn: false, instr: ldmdb, part: 1 }
- { code: gpram, data: flash, lbEn: false, instr: ldmdb, part: 2 }
