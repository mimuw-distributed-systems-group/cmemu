...
- { code: "gpram", lbEn: True, gpram_part: 3 }
- { code: "gpram", lbEn: True, gpram_part: 4 }
- { code: "gpram", lbEn: True, gpram_part: 5 }
- { code: "gpram", lbEn: True, gpram_part: 6 }
- { code: "gpram", lbEn: True, gpram_part: 7 }
