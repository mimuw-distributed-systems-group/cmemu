...
dumped_symbols:
  ...
  lsucnts: 40 words
configurations:
- { code: "gpram", addr: "gpram", lbEn: True, gpram_part: 0 }
- { code: "gpram", addr: "gpram", lbEn: True, gpram_part: 1 }
- { code: "gpram", addr: "sram", lbEn: True, gpram_part: 0 }
- { code: "gpram", addr: "sram", lbEn: True, gpram_part: 1 }
- { code: "gpram", addr: "flash", lbEn: True, gpram_part: 0 }
- { code: "gpram", addr: "flash", lbEn: True, gpram_part: 1 }
- { code: "gpram", addr: "flash", lbEn: False, gpram_part: 0 }
- { code: "gpram", addr: "flash", lbEn: False, gpram_part: 1 }
