...
dumped_symbols:
  ...
  lsucnts: 312 words
configurations:
- { code: "gpram", memory: "gpram", lbEn: true, part: 0 }
- { code: "gpram", memory: "gpram", lbEn: true, part: 1 }
- { code: "gpram", memory: "gpram", lbEn: true, part: 2 }
- { code: "gpram", memory: "gpram", lbEn: true, part: 3 }
- { code: "gpram", memory: "gpram", lbEn: true, part: 4 }
- { code: "gpram", memory: "sram", lbEn: true, part: 0 }
- { code: "gpram", memory: "sram", lbEn: true, part: 1 }
- { code: "gpram", memory: "sram", lbEn: true, part: 2 }
- { code: "gpram", memory: "sram", lbEn: true, part: 3 }
- { code: "gpram", memory: "sram", lbEn: true, part: 4 }
- { code: "gpram", memory: "flash", lbEn: true, part: 0 }
- { code: "gpram", memory: "flash", lbEn: true, part: 1 }
- { code: "gpram", memory: "flash", lbEn: true, part: 2 }
- { code: "gpram", memory: "flash", lbEn: true, part: 3 }
- { code: "gpram", memory: "flash", lbEn: true, part: 4 }
- { code: "gpram", memory: "flash", lbEn: false, part: 0 }
- { code: "gpram", memory: "flash", lbEn: false, part: 1 }
- { code: "gpram", memory: "flash", lbEn: false, part: 2 }
- { code: "gpram", memory: "flash", lbEn: false, part: 3 }
- { code: "gpram", memory: "flash", lbEn: false, part: 4 }

- { code: "sram", memory: "gpram", lbEn: true, part: 0 }
- { code: "sram", memory: "gpram", lbEn: true, part: 1 }
- { code: "sram", memory: "gpram", lbEn: true, part: 2 }
- { code: "sram", memory: "gpram", lbEn: true, part: 3 }
...
- { code: "flash", memory: "gpram", lbEn: true, part: 0 }
- { code: "flash", memory: "gpram", lbEn: true, part: 1 }
- { code: "flash", memory: "gpram", lbEn: true, part: 2 }
- { code: "flash", memory: "gpram", lbEn: false, part: 0 }
- { code: "flash", memory: "gpram", lbEn: false, part: 1 }
- { code: "flash", memory: "gpram", lbEn: false, part: 2 }
