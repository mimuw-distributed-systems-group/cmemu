...
configurations:
- { code: gpram, memory: gpram }
- { code: gpram, memory: sram }
- { code: gpram, memory: flash }
- { code: sram, memory: gpram }
- { code: sram, memory: sram }
- { code: sram, memory: flash }
- { code: flash, memory: gpram }
- { code: flash, memory: sram }
- { code: flash, memory: flash }
...
