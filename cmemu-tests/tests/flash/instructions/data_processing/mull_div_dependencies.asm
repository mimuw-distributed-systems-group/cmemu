...
dumped_symbols:
  ...
  times: 264 words
configurations:
- { aInstructionPart: 1, bInstructionPart: 1, extraInstr: "" }
- { aInstructionPart: 1, bInstructionPart: 2, extraInstr: "" }
- { aInstructionPart: 2, bInstructionPart: 1, extraInstr: "" }
- { aInstructionPart: 2, bInstructionPart: 2, extraInstr: "" }
# We've heard a rumour of a chained MLA... Large tests would be useful too
- { aInstructionPart: 1, bInstructionPart: 1, extraInstr: "mla.w r11, r10, r9, r11" }
- { aInstructionPart: 1, bInstructionPart: 2, extraInstr: "mla.w r11, r10, r9, r11" }
- { aInstructionPart: 2, bInstructionPart: 1, extraInstr: "mla.w r11, r10, r9, r11" }
- { aInstructionPart: 2, bInstructionPart: 2, extraInstr: "mla.w r11, r10, r9, r11" }
...
