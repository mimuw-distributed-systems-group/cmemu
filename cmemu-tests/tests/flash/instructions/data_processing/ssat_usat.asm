...
dumped_symbols:
  ...
  flags: 100 words
configurations:
- { code: "gpram", lbEn: True, tested_val: "0x01234567", testedInstr: "ssat.w" }
- { code: "gpram", lbEn: True, tested_val: "0xfedcba98", testedInstr: "ssat.w" }
- { code: "gpram", lbEn: True, tested_val: "0x000A0B0C", testedInstr: "ssat.w" }
- { code: "gpram", lbEn: True, tested_val: "0x01234567", testedInstr: "usat.w" }
- { code: "gpram", lbEn: True, tested_val: "0xfedcba98", testedInstr: "usat.w" }
- { code: "gpram", lbEn: True, tested_val: "0x000A0B0C", testedInstr: "usat.w" }
