...
configurations:
# add tests
- { code: "gpram", lbEn: True, instr: "add.w", srcReg: "r6" }
- { code: "gpram", lbEn: True, instr: "adds.w", srcReg: "r6" }
...
- { code: "gpram", lbEn: True, instr: "add.w", srcReg: "sp" }
- { code: "gpram", lbEn: True, instr: "adds.w", srcReg: "sp" }
...
# adc tests
- { code: "gpram", lbEn: True, instr: "adc.w", srcReg: "r6" }
- { code: "gpram", lbEn: True, instr: "adcs.w", srcReg: "r6" }
...
# sub tests
- { code: "gpram", lbEn: True, instr: "sub.w", srcReg: "r6" }
- { code: "gpram", lbEn: True, instr: "subs.w", srcReg: "r6" }
...
- { code: "gpram", lbEn: True, instr: "sub.w", srcReg: "sp" }
- { code: "gpram", lbEn: True, instr: "subs.w", srcReg: "sp" }
...
# sbc tests
- { code: "gpram", lbEn: True, instr: "sbc.w", srcReg: "r6" }
- { code: "gpram", lbEn: True, instr: "sbcs.w", srcReg: "r6" }
