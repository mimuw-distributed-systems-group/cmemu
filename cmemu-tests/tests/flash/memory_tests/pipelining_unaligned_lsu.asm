...
{% set addr_1, addr_2 = [
    ("sram_chunk+2", "flash_chunk+10"),
    ("sram_chunk+2", "sram_chunk+2"),
    ("0x20004419", "0x11000001"),
    ("sram_chunk+2", "flash_chunk+8"),
    ("flash_chunk+10", "0x11000001"),
][data] %}

{% set pad_pos, pad_instr = pad %}

{% block tested_code  %}
{% for align_pad in ("", "add.w r5, r11", "add.n r5, r11") %}
