...
dumped_symbols:
  ...
  lsucnts: auto
configurations:
    - {code: flash, lbEn: True, instrs: ["ldr.n"],  it: False}
    - {code: flash, lbEn: True, instrs: ["str.n"],  it: False}
    - {code: flash, lbEn: False, instrs: ["ldr.n"], it: False}
    - {code: flash, lbEn: False, instrs: ["str.n"], it: False}
    - {code: flash, lbEn: True, instrs: ["ldr.n"],  it: True }
    - {code: flash, lbEn: True, instrs: ["str.n"],  it: True }
    - {code: flash, lbEn: False, instrs: ["ldr.n"], it: True }
    - {code: flash, lbEn: False, instrs: ["str.n"], it: True }
    ...
    # - {code: gpram, lbEn: True, instrs: ["ldr.n"], it: False}
    # - {code: gpram, lbEn: True, instrs: ["str.n"], it: False}
    # - {code: gpram, lbEn: True, instrs: ["ldr.n"], it: True }
    # - {code: gpram, lbEn: True, instrs: ["str.n"], it: True }
...
