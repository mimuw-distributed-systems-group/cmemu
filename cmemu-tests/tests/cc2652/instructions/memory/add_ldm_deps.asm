...
dumped_symbols:
  ...
  lsucnts: 20 words
configurations:
- { code: "sram", addr: "sram", addrReg: "r2", ldrInstr: "ldm.w" }
- { code: "sram", addr: "sram", addrReg: "r3", ldrInstr: "ldm.w" }
- { code: "sram", addr: "sram", addrReg: "r2", ldrInstr: "ldmdb.w" }
- { code: "sram", addr: "sram", addrReg: "r3", ldrInstr: "ldmdb.w" }
- { code: "flash", addr: "sram", addrReg: "r2", ldrInstr: "ldm.w" }
- { code: "flash", addr: "sram", addrReg: "r3", ldrInstr: "ldm.w" }
- { code: "flash", addr: "sram", addrReg: "r2", ldrInstr: "ldmdb.w" }
- { code: "flash", addr: "sram", addrReg: "r3", ldrInstr: "ldmdb.w" }
...
